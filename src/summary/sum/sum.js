...
export const sum = () => {
    ...
    const sum_elementAsideTicketQuantity = document.getElementById('ticketsQuantity') 
    let sum = () =>{
        ...
        sum_elementAsideTicketQuantity.innerHTML = parseInt(window.people) +parseInt(window.young) + parseInt(window.child)
    }
    sum()
}